				...
				<div class="xans-element- xans-board xans-board-listpackage-1002 xans-board-listpackage xans-board-1002 ">
					<div class="xans-element- xans-board xans-board-title-1002 xans-board-title xans-board-1002 ">
						<div class="path">
							...
							<ol>
								<li>홈</li>
								<li title="현재 위치"><a href="/faq.do"><strong>FAQ</strong></a></li>
							</ol>
						</div>
						<div class="titleArea">
							<h2>
							...
							<p>LOOKPLE(룩플) 자주찾는질문 입니다.</p>
						</div>
						<div class="xans-element- xans-layout xans-layout-boardinfo faq_board_list">
					...
					<div class="ec-base-table typeList ">
							...
							<tbody class="xans-element- xans-board xans-board-notice-1002 xans-board-notice xans-board-1002 center">
								<tr style="background-color: #FFFFFF; color: #555555;" class="xans-record-">
									...
									<td class="subject left txtBreak">
										<strong> 
											<a href="/list_detail.do" style="color: #555555;">네이버페이반품 공지사항</a>
								...
								<tr style="background-color: #FFFFFF; color: #555555;" class="xans-record-">
									...
									<td class="subject left txtBreak">
										<strong> 
											<a href="/article/notice/1/7914/" style="color: #555555;">상품치수 측정 공지사항</a>
											<img src="//img.echosting.cafe24.com/design/skin/admin/ko_KR/ico_attach2.gif" alt="파일첨부" class="ec-common-rwd-image" />
											<span class="txtInfo"></span>
										</strong>
									</td>
									<td>룩플 LOOKPLE</td>
						...
						<p class="xans-element- xans-board xans-board-empty-1002 xans-board-empty xans-board-1002 message">검색결과가 없습니다.</p>
					</div>
					<div class="xans-element- xans-board xans-board-buttonlist-1002 xans-board-buttonlist xans-board-1002 ec-base-button displaynone ">
						<span class="gRight"> 
							<a href="#none" class="btnSubmitFix sizeS displaynone">글쓰기</a>
						</span>
					</div>
				</div>
