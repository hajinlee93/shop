			...
			<div class="all_width">
				...
				<form id="joinForm" name="joinForm"
					...
					<input id="useSimpleSignin" name="useSimpleSignin" value="F"
						...
						name="is_display_register_business" value="T" type="hidden" /> <input
						id="use_checking_cssn_duplication"
						name="use_checking_cssn_duplication" value="F" type="hidden" /> <input
					...
					<input id="login_id_type" name="login_id_type" value="id"
						...
						type="hidden" /> <input id="display_flag_marketing_consent_check"
					...
					<input id="is_display_register_eng_name"
						...
						id="__isRuleBasedAddrForm" name="__isRuleBasedAddrForm" value="F"
						type="hidden" /> <input id="address_direct_input_check"
						name="address_direct_input_check" value="F" type="hidden" /> <input
						id="display_required_address" name="display_required_address"
						value="F" type="hidden" /> <input id="display_required_address2"
						name="display_required_address2" value="F" type="hidden" /> <input
						...
						type="hidden" /> <input id="isMobileVerify" name="isMobileVerify"
						value="F" type="hidden" /> <input id="is_display_register_phone"
						name="is_display_register_phone" value="F" type="hidden" /> <input
						id="display_required_phone" name="display_required_phone"
						value="F" type="hidden" /> <input id="display_register_phone"
						name="display_register_phone" value="T" type="hidden" /> <input
						...
						type="hidden" /> <input id="nick_name_flag" name="nick_name_flag"
						value="F" type="hidden" /> <input id="nick_name_confirm"
						name="nick_name_confirm" value="F" type="hidden" /> <input
					...
					<input id="is_display_bank" name="is_display_bank" value="T"
					...
					<input id="display_required_job" name="display_required_job"
						...
						value="F" type="hidden" /> <input id="display_required_internet"
						...
						value="F" type="hidden" /> <input id="display_required_reco_id"
						name="display_required_reco_id" value="F" type="hidden" /> <input
						id="display_required_add1" name="display_required_add1" value="F"
						...
						value="F" type="hidden" /> <input id="is_use_checking_join_info"
								...
								<tbody>
									<tr class="">
										...
										<td><input id="member_type0" name="member_type"
											...
											type="radio" checked="checked" /><label for="member_type0">개인회원</label>
											<input id="member_type1" name="member_type"
											fw-filter="isFill" fw-label="회원구분" fw-msg="" value="c"
											type="radio" /><label for="member_type1">사업자회원</label> <input
											id="member_type2" name="member_type" fw-filter="isFill"
											fw-label="회원구분" fw-msg="" value="f" type="radio" /><label
											for="member_type2">외국인회원(foreigner)</label></td>
									</tr>
									<tr id="companyWrap">
										<th scope="row">사업자구분 <img
											src="//img.echosting.cafe24.com/skin/base/common/ico_required_blue.gif"
											alt="필수" /></th>
										<td><input id="company_type0" name="company_type"
											fw-filter="" fw-label="사업자구분" fw-msg="" value="p"
											type="radio" checked="checked" /><label for="company_type0">개인사업자</label>
											<input id="company_type1" name="company_type" fw-filter=""
											fw-label="사업자구분" fw-msg="" value="c" type="radio" /><label
											for="company_type1">법인사업자</label></td>
									</tr>
									<tr id="authMember">
										<th scope="row">회원인증 <img
											src="//img.echosting.cafe24.com/skin/base/common/ico_required_blue.gif"
											alt="필수" /></th>
										<td>
											<div id="authWrap" style="display: none;">
												...
												<div id="personAuth">
													...
													<div id="ipinWrap">
														<a href="#none" class="btnNormal"
															onclick="ipinPopup('hanggi4043'); return false;"><img
															src="//img.echosting.cafe24.com/skin/base/common/btn_icon_ipin.gif"
															alt="" /> 아이핀인증</a>
														<p class="gBlank5">
															아이핀이란, 회원님의 개인정보 보호를 위해 웹사이트에 주민등록번호를 제공하지 않고 본인임을 확인하는
															인터넷상의 개인식별번호 서비스입니다. <br />아이핀을 통한 가입을 원하시면 아이핀 인증 버튼을
															눌러 진행해 주십시오.
														</p>
													</div>
													<div id="mobileWrap">
														<a href="#none" class="btnNormal"
															onclick="mobilePopup('hanggi4043' , 'kcp' ); return false;"><img
												...
												<div id="businessAuth">
													<ul class="grid">
														<li>법인명<br /> <input id="bname" name="bname"
															fw-filter="isMax[20]" fw-label="법인명" fw-msg=""
															class="inputTypeText" placeholder="" maxlength="20"
															value="" type="text" /></li>
														<li>법인번호<br /> <input id="bssn1" name="bssn1"
															fw-filter="isMax[6]" fw-label="bssn1" fw-msg=""
															class="inputTypeText" placeholder="" maxlength="6"
															value="" type="text" /> - <input id="bssn2" name="bssn2"
															fw-filter="isMax[7]" fw-label="bssn2" fw-msg=""
															maxlength="7" autocomplete="off" value="" type="password" />
															<a href="#none" class="btnNormal"
															onclick="CompanyCheck.checkDupl(); return false;">중복확인</a>
														</li>
													</ul>
												</div>
												...
												<div id="foreignerAuth">
													<ul class="grid">
														<li>이름(Name) <input id="foreigner_name"
															name="foreigner_name" fw-filter=""
															fw-label="foreigner_name" fw-msg="" class="inputTypeText"
															placeholder="" maxlength="20" value="" type="text" /></li>
														<li><input id="foreigner_type0" name="foreigner_type"
															fw-filter="" fw-label="foreigner_type" fw-msg=""
															value="f" type="radio" checked="checked" /><label
															for="foreigner_type0">외국인 등록번호</label> <input
															id="foreigner_ssn" name="foreigner_ssn" fw-filter=""
															fw-label="foreigner_ssn" fw-msg="" class="inputTypeText"
															placeholder="" value="" type="text" /> <a href="#none"
															class="btnNormal" onclick="checkForeignerNumber();">중복확인</a>
														</li>
													</ul>
													<div id="foreignerPersonWrap">
														<p class="gBlank5">
															회사는 회원의 본인확인 및 서비스제공을 위하여 고유식별정보를 수집하여 보관하며 개인정보처리방침에 따라
															<br />보유 및 이용합니다. 고유식별정보 제공을 거부하는 경우 서비스 이용이 제한됩니다.
														</p>
														<p>
															<input id="f_identification_check0"
																name="f_identification_check[]" fw-filter=""
																fw-label="고유식별정보 처리" fw-msg="고유식별정보 처리 방침에 동의해 주세요."
																value="1" type="checkbox" /><label
																for="f_identification_check0">고유식별정보 처리에 동의 합니다.</label>
														</p>
													</div>
								...
								<tbody>
												...
												<div class="ec-base-tooltip typeUpper">
													<div class="content">
														...
														<ul class="ec-base-help typeDash gBlank10 txtWarn">
															- 대소문자/숫자 4자~16자
															<br>- 특수문자 및 공백 입력 불가능 <br>- 연속된 문자, 숫자 사용 불가능
																	<br>- 동일한 문자, 숫자를 반복해서 사용 불가능 <br>- 아이디 포함
																			불가능 
														</ul>
													</div>
									...
									<tr id="companyNoRow">
										...
										<td id="companySsn"><input id="cssn" name="cssn"
											...
											class="inputTypeText" placeholder="" maxlength="20" value=""
											type="text" /> <a href="#none" class="btnNormal displaynone"
											onclick="checkCssnDupl(); return false;">중복확인</a> <span
											id="cssnMsg"></span></td>
									</tr>
									<tr id="companyConditionRow">
										<th scope="row">업태 <img
											src="//img.echosting.cafe24.com/skin/base/common/ico_required_blue.gif"
											alt="필수" /></th>
										<td id="companyCondition"><input id="company_condition"
											name="company_condition" fw-filter="isFill&isMax[50]"
											fw-label="업태" fw-msg="" class="inputTypeText" placeholder=""
											maxlength="50" value="" type="text" /></td>
									</tr>
									<tr id="companyLineRow">
										<th scope="row">종목 <img
											src="//img.echosting.cafe24.com/skin/base/common/ico_required_blue.gif"
											alt="필수" /></th>
										<td id="companyLine"><input id="company_line"
											name="company_line" fw-filter="isFill&isMax[50]"
											fw-label="종목" fw-msg="" class="inputTypeText" placeholder=""
											maxlength="50" value="" type="text" /></td>
									</tr>
									<tr id="nation">
										<th>국적 <img
										...
										<td><select id="citizenship" name="citizenship"
											fw-filter="isFill" fw-label="국적" fw-msg="">
												...
												<option value="VC">세인트빈센트그레나딘(SAINT VINCENT AND THE
													GRENADINES)</option>
									...
									<tr class="">
										...
										<td><ul class="ec-address">
												<li id="join_country_wrap" class="displaynone"><select
													...
													class="ec-base-label displaynone"> <input
														id="join_directInputCheck" name="join_directInputCheck"
														type="checkbox"> <label
															id="join_directInputCheckLabel"
															for="join_directInputCheckLabel">직접입력</label></span></li>

												<li id="join_baseAddr_wrap" class="displaynone"><input
													id="addr1" name="addr1" placeholder="기본주소" fw-filter=""
													class="inputTypeText displaynone" type="text" size="60"
													maxlength="100" disabled></li>

												<li id="join_detailAddr_wrap" class="displaynone"><input
												...
												<li id="join_state_wrap" class="displaynone"><select
												...
												<li id="join_city_wrap" class="displaynone"><input
													id="city_name" name="city_name" placeholder="시/군/도시"
													fw-filter="" class="inputTypeText displaynone" type="text"
													size="30" maxlength="50" disabled></li>

												<li id="join_street_wrap" class="displaynone"><input
												...
												<li id="join_zipcode_wrap"
													...
													maxlength="14" disabled>
														<button id="postBtn" class="btnBasic displaynone"
															type="button" disabled>주소검색</button> <span
														class="ec-base-label"> <input id="nozip"
															name="nozip" class="displaynone" type="checkbox" disabled>
																<label id="join_zipcode_check_label" for="nozip"
																class="displaynone" disabled>우편번호 없음</label></span><span
														id="join_zipcodeNotFoundMsg_wrap"
									...
									<tr class="">
										...
										<td><select id="mobile1" name="mobile[]"
											...
											<button type="button" id="btn_action_verify_mobile"
												class="btnNormal displaynone"
												onclick="memberVerifyMobile.joinSendVerificationNumber(); return false;">인증번호받기</button>
									...
									<tr class="displaynone">
										...
										<td><input id="is_lifetime0" name="is_lifetime"
											...
											<ul class="txtDesc">
												<li>평생회원으로 가입하시면 <strong>룩플 LOOKPLE</strong> 회원 탈퇴시까지는
													휴면회원으로 전환되지 않으며, 고객님의 개인정보가 탈퇴시까지 안전하게 보관됩니다.
												</li>
										...
										<td>
											<div class="interest">
												...
												<input id="inter_check15" name="inter_check[]" fw-filter=""
													...
													name="inter_check[]" fw-filter="" fw-label="관심분야" fw-msg=""
													value="16" type="checkbox" /><label for="inter_check16">스포츠/레져/취미</label>
												<input id="inter_check17" name="inter_check[]" fw-filter=""
													...
													name="inter_check[]" fw-filter="" fw-label="관심분야" fw-msg=""
													value="19" type="checkbox" /><label for="inter_check19">컴퓨터/게임</label>
												<input id="inter_check20" name="inter_check[]" fw-filter=""
													...
													name="inter_check[]" fw-filter="" fw-label="관심분야" fw-msg=""
													value="22" type="checkbox" /><label for="inter_check22">자동차/여행</label>
												<input id="inter_check23" name="inter_check[]" fw-filter=""
													...
													name="inter_check[]" fw-filter="" fw-label="관심분야" fw-msg=""
													value="25" type="checkbox" /><label for="inter_check25">어학강좌</label>
											...
											<dl class="ec-base-desc typeDot">
												...
												<dd>
													<input id="bank_account_owner" name="bank_account_owner"
														fw-filter="isFill" fw-label="예금주" fw-msg=""
												...
												<dd>
													<select id="refund_bank_code" name="refund_bank_code"
														fw-filter="isFill" fw-label="은행명" fw-msg="">
												...
												<dd>
													<input id="bank_account_no" name="bank_account_no"
														fw-filter="isFill" fw-label="계좌번호" fw-msg=""
														class="inputTypeText" placeholder="" autocomplete="off"
														value="" type="text" />
												</dd>
											</dl>
								...
								<div class="fr-view fr-view-mall-agreement">
									<p>
										제1조(목적)<br>이 약관은 OO 회사(전자상거래 사업자)가 운영하는 OO 사이버 몰(이하 “몰”이라
											...
											권리?의무 및 책임사항을 규정함을 목적으로 합니다.<br>※「PC통신, 무선 등을 이용하는
											...
											있습니다.<br>② “몰은 이용자가 약관에 동의하기에 앞서 약관에 정하여져 있는 내용 중
												...
												등을 제공하여 이용자의 확인을 구하여야 합니다.<br>③ “몰”은 「전자상거래 등에서의 소비자보호에
													...
													「소비자기본법」 등 관련 법을 위배하지 않는 범위에서 이 약관을 개정할 수 있습니다.<br>④
														...
														경우에는 최소한 30일 이상의 사전 유예기간을 두고 공지합니다. 이 경우 “몰“은 개정 전 내용과 개정
														후 내용을 명확하게 비교하여 이용자가 알기 쉽도록 표시합니다. <br>⑤ “몰”이 약관을 개정할
															경우에는 그 개정약관은 그 적용일자 이후에 체결되는 계약에만 적용되고 그 이전에 이미 체결된 계약에
															대해서는 개정 전의 약관조항이 그대로 적용됩니다. 다만 이미 계약을 체결한 이용자가 개정약관 조항의
															적용을 받기를 원하는 뜻을 제3항에 의한 개정약관의 공지기간 내에 “몰”에 송신하여 “몰”의 동의를
															받은 경우에는 개정약관 조항이 적용됩니다.<br>⑥ 이 약관에서 정하지 아니한 사항과 이
									...
									<p>
										제4조(서비스의 제공 및 변경) <br>① “몰”은 다음과 같은 업무를 수행합니다.<br>&nbsp;
												1. 재화 또는 용역에 대한 정보 제공 및 구매계약의 체결<br>&nbsp; 2. 구매계약이 체결된
													재화 또는 용역의 배송<br>&nbsp; 3. 기타 “몰”이 정하는 업무<br>②
															...
															제공일자를 명시하여 현재의 재화 또는 용역의 내용을 게시한 곳에 즉시 공지합니다.<br>③
																“몰”이 제공하기로 이용자와 계약을 체결한 서비스의 내용을 재화등의 품절 또는 기술적 사양의 변경
										...
										제6조(회원가입) <br>① 이용자는 “몰”이 정한 가입 양식에 따라 회원정보를 기입한 후 이 약관에
											동의한다는 의사표시를 함으로서 회원가입을 신청합니다.<br>② “몰”은 제1항과 같이 회원으로 가입할
												것을 신청한 이용자 중 다음 각 호에 해당하지 않는 한 회원으로 등록합니다.<br>&nbsp; 1.
													가입신청자가 이 약관 제7조제3항에 의하여 이전에 회원자격을 상실한 적이 있는 경우, 다만 제7조제3항에
													의한 회원자격 상실 후 3년이 경과한 자로서 “몰”의 회원재가입 승낙을 얻은 경우에는 예외로 한다.<br>&nbsp;
														2. 등록 내용에 허위, 기재누락, 오기가 있는 경우<br>&nbsp; 3. 기타 회원으로
															등록하는 것이 “몰”의 기술상 현저히 지장이 있다고 판단되는 경우<br>③ 회원가입계약의 성립
																시기는 “몰”의 승낙이 회원에게 도달한 시점으로 합니다.<br>④ 회원은 회원가입 시 등록한
																	사항에 변경이 있는 경우, 상당한 기간 이내에 “몰”에 대하여 회원정보 수정 등의 방법으로 그
																	변경사항을 알려야 합니다. 
									</p>
									<p>
														...
														관련하여 회원이 부담하는 채무를 기일에 지급하지 않는 경우<br>&nbsp; 3. 다른 사람의
															“몰” 이용을 방해하거나 그 정보를 도용하는 등 전자상거래 질서를 위협하는 경우<br>&nbsp;
																4. “몰”을 이용하여 법령 또는 이 약관이 금지하거나 공서양속에 반하는 행위를 하는 경우<br>③
																	...
																	사유가 시정되지 아니하는 경우 “몰”은 회원자격을 상실시킬 수 있습니다.<br>④ “몰”이
											...
											신청하며, “몰”은 이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야 합니다.<br>&nbsp;
												1. 재화 등의 검색 및 선택<br>&nbsp; 2. 받는 사람의 성명, 주소, 전화번호,
													전자우편주소(또는 이동전화번호) 등의 입력<br>&nbsp; 3. 약관내용, 청약철회권이 제한되는
														서비스, 배송료?설치비 등의 비용부담과 관련한 내용에 대한 확인<br>&nbsp; 4. 이
															약관에 동의하고 위 3.호의 사항을 확인하거나 거부하는 표시(예, 마우스 클릭)<br>&nbsp;
																5. 재화등의 구매신청 및 이에 관한 확인 또는 “몰”의 확인에 대한 동의<br>&nbsp;
																	6. 결제방법의 선택<br>② “몰”이 제3자에게 구매자 개인정보를 제공?위탁할 필요가
																		있는 경우 실제 구매신청 시 구매자의 동의를 받아야 하며, 회원가입 시 미리 포괄적으로 동의를
																		받지 않습니다. 이 때 “몰”은 제공되는 개인정보 항목, 제공받는 자, 제공받는 자의 개인정보
																		이용 목적 및 보유?이용 기간 등을 구매자에게 명시하여야 합니다. 다만 「정보통신망이용촉진 및
																		정보보호 등에 관한 법률」 제25조 제1항에 의한 개인정보 처리위탁의 경우 등 관련 법령에 달리
																		정함이 있는 경우에는 그에 따릅니다. 
									</p>
									<p>
													...
													등 청소년보호법에서 금지하는 재화 및 용역을 구매하는 경우<br>&nbsp; 3. 기타 구매신청에
														승낙하는 것이 “몰” 기술상 현저히 지장이 있다고 판단하는 경우<br>② “몰”의 승낙이
															제12조제1항의 수신확인통지형태로 이용자에게 도달한 시점에 계약이 성립한 것으로 봅니다.<br>③
																“몰”의 승낙의 의사표시에는 이용자의 구매 신청에 대한 확인 및 판매가능 여부, 구매신청의 정정 취소
									...
									<p>
										제11조(지급방법)<br>“몰”에서 구매한 재화 또는 용역에 대한 대금지급방법은 다음 각 호의 방법중
											...
											수수료도 추가하여 징수할 수 없습니다.<br>1. 폰뱅킹, 인터넷뱅킹, 메일 뱅킹 등의 각종 계좌이체
												<br>2. 선불카드, 직불카드, 신용카드 등의 각종 카드 결제<br>3. 온라인무통장입금<br>4.
															전자화폐에 의한 결제<br>5. 수령 시 대금지급<br>6. 마일리지 등 “몰”이
																	지급한 포인트에 의한 결제<br>7. “몰”과 계약을 맺었거나 “몰”이 인정한 상품권에
																		의한 결제 <br>8. 기타 전자적 지급 방법에 의한 대금 지급 등 
									</p>
									<p>
										...
										제15조(청약철회 등)<br>① “몰”과 재화등의 구매에 관한 계약을 체결한 이용자는 「전자상거래
											...
											소비자보호에 관한 법률」에 달리 정함이 있는 경우에는 동 법 규정에 따릅니다. <br>② 이용자는
												재화 등을 배송 받은 경우 다음 각 호의 1에 해당하는 경우에는 반품 및 교환을 할 수 없습니다.<br>&nbsp;
													...
													위하여 포장 등을 훼손한 경우에는 청약철회를 할 수 있습니다)<br>&nbsp; 2. 이용자의
														사용 또는 일부 소비에 의하여 재화 등의 가치가 현저히 감소한 경우<br>&nbsp; 3.
															시간의 경과에 의하여 재판매가 곤란할 정도로 재화등의 가치가 현저히 감소한 경우<br>&nbsp;
																4. 같은 성능을 지닌 재화 등으로 복제가 가능한 경우 그 원본인 재화 등의 포장을 훼손한 경우<br>③
																	제2항제2호 내지 제4호의 경우에 “몰”이 사전에 청약철회 등이 제한되는 사실을 소비자가 쉽게 알
																	수 있는 곳에 명기하거나 시용상품을 제공하는 등의 조치를 하지 않았다면 이용자의 청약철회 등이
																	제한되지 않습니다.<br>④ 이용자는 제1항 및 제2항의 규정에 불구하고 재화 등의 내용이
																		표시?광고 내용과 다르거나 계약내용과 다르게 이행된 때에는 당해 재화 등을 공급받은 날부터 3월
										...
										제17조(개인정보보호)<br>① “몰”은 이용자의 개인정보 수집시 서비스제공을 위하여 필요한 범위에서
											최소한의 개인정보를 수집합니다. <br>② “몰”은 회원가입시 구매계약이행에 필요한 정보를 미리
												...
												특정 개인정보를 수집하는 경우에는 그러하지 아니합니다.<br>③ “몰”은 이용자의 개인정보를
													수집?이용하는 때에는 당해 이용자에게 그 목적을 고지하고 동의를 받습니다. <br>④ “몰”은
														수집된 개인정보를 목적외의 용도로 이용할 수 없으며, 새로운 이용목적이 발생한 경우 또는 제3자에게
														제공하는 경우에는 이용?제공단계에서 당해 이용자에게 그 목적을 고지하고 동의를 받습니다. 다만, 관련
														법령에 달리 정함이 있는 경우에는 예외로 합니다.<br>⑤ “몰”이 제2항과 제3항에 의해
															이용자의 동의를 받아야 하는 경우에는 개인정보보호 책임자의 신원(소속, 성명 및 전화번호, 기타
															연락처), 정보의 수집목적 및 이용목적, 제3자에 대한 정보제공 관련사항(제공받은자, 제공목적 및
															제공할 정보의 내용) 등 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」 제22조제2항이 규정한
															사항을 미리 명시하거나 고지해야 하며 이용자는 언제든지 이 동의를 철회할 수 있습니다.<br>⑥
																이용자는 언제든지 “몰”이 가지고 있는 자신의 개인정보에 대해 열람 및 오류정정을 요구할 수 있으며
																“몰”은 이에 대해 지체 없이 필요한 조치를 취할 의무를 집니다. 이용자가 오류의 정정을 요구한
																경우에는 “몰”은 그 오류를 정정할 때까지 당해 개인정보를 이용하지 않습니다.<br>⑦
																	“몰”은 개인정보 보호를 위하여 이용자의 개인정보를 처리하는 자를 최소한으로 제한하여야 하며
																	신용카드, 은행계좌 등을 포함한 이용자의 개인정보의 분실, 도난, 유출, 동의 없는 제3자 제공,
																	변조 등으로 인한 이용자의 손해에 대하여 모든 책임을 집니다.<br>⑧ “몰” 또는
																		그로부터 개인정보를 제공받은 제3자는 개인정보의 수집목적 또는 제공받은 목적을 달성한 때에는 당해
																		개인정보를 지체 없이 파기합니다.<br>⑨ “몰”은 개인정보의 수집?이용?제공에 관한
																			동의란을 미리 선택한 것으로 설정해두지 않습니다. 또한 개인정보의 수집?이용?제공에 관한
																			이용자의 동의거절시 제한되는 서비스를 구체적으로 명시하고, 필수수집항목이 아닌 개인정보의
																			수집?이용?제공에 관한 이용자의 동의 거절을 이유로 회원가입 등 서비스 제공을 제한하거나
																			거절하지 않습니다. 
									</p>
									<p>
										제18조(“몰“의 의무)<br>① “몰”은 법령과 이 약관이 금지하거나 공서양속에 반하는 행위를 하지
											않으며 이 약관이 정하는 바에 따라 지속적이고, 안정적으로 재화?용역을 제공하는데 최선을 다하여야 합니다.<br>②
												...
												보안 시스템을 갖추어야 합니다.<br>③ “몰”이 상품이나 용역에 대하여 「표시?광고의 공정화에
													관한 법률」 제3조 소정의 부당한 표시?광고행위를 함으로써 이용자가 손해를 입은 때에는 이를 배상할 책임을
													집니다.<br>④ “몰”은 이용자가 원하지 않는 영리목적의 광고성 전자우편을 발송하지 않습니다.
									...
									<p>
										제20조(이용자의 의무)<br>이용자는 다음 행위를 하여서는 안 됩니다.<br>1. 신청 또는
												변경시 허위 내용의 등록<br>2. 타인의 정보 도용<br>3. “몰”에 게시된 정보의
														변경<br>4. “몰”이 정한 정보 이외의 정보(컴퓨터 프로그램 등) 등의 송신 또는 게시<br>5.
																“몰” 기타 제3자의 저작권 등 지적재산권에 대한 침해<br>6. “몰” 기타 제3자의
																	명예를 손상시키거나 업무를 방해하는 행위<br>7. 외설 또는 폭력적인 메시지, 화상,
										...
										제23조(분쟁해결)<br>① “몰”은 이용자가 제기하는 정당한 의견이나 불만을 반영하고 그 피해를
											보상처리하기 위하여 피해보상처리기구를 설치?운영합니다.<br>② “몰”은 이용자로부터 제출되는
												...
												사유와 처리일정을 즉시 통보해 드립니다.<br>③ “몰”과 이용자 간에 발생한 전자상거래 분쟁과
													관련하여 이용자의 피해구제신청이 있는 경우에는 공정거래위원회 또는 시?도지사가 의뢰하는 분쟁조정기관의
													조정에 따를 수 있습니다. 
									</p>
									<p>
						...
						<div class="ec-base-box typeThinBg agreeArea displaynone">
							...
							<p class="check">
								<span>개인정보 수집 및 이용에 동의하십니까?</span> <input
									...
									fw-label="개인정보 수집 및 이용 동의 (선택)" fw-msg="" class="ec-base-chk"
									value="T" type="checkbox" /><label
									for="agree_privacy_optional_check0"></label>
							</p>
						</div>
						<div class="ec-base-box typeThinBg agreeArea displaynone">
						...
						<div class="ec-base-box typeThinBg agreeArea ">
							...
							<ul class="check">
								...
								<li class=""><span>이메일 수신을 동의하십니까?</span> <input
									...
									fw-label="is_news_mail" fw-msg="" class="ec-base-chk" value="T"
									type="checkbox" /><label for=is_news_mail0>동의함</label></li>
							</ul>
						</div>
									...
									<table border="1" summary="">
										...
										<tbody>
											...
											<tr class="displaynone">
												...
												<td><span id="ec_shop_member_confirm_field-hint"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row">비밀번호 확인 답변</th>
												<td><span id="ec_shop_member_confirm_field-hint_answer"></span></td>
											</tr>
											<tr>
											...
											<!-- 외국인 회원 정보 -->
											<tr>
												<th scope="row" id="ec_shop_member_confirm-ssn_title"></th>
												<td id="ec_shop_member_confirm-ssn_contents"></td>
											</tr>
											<!-- // 외국인 회원 정보 -->
											<tr id="ec_shop_member_confirm-company_name">
												<th scope="row">상호명</th>
												<td></td>
											</tr>
											<tr id="ec_shop_member_confirm-company_ssn">
												<th scope="row">사업자번호</th>
												<td></td>
											</tr>
											<tr id="ec_shop_member_confirm-company_condition">
												<th scope="row">업태</th>
												<td></td>
											</tr>
											<tr id="ec_shop_member_confirm-company_line">
												<th scope="row">종목</th>
												<td></td>
											</tr>
											<tr class="displaynone">
												<th scope="row">이름(영문)</th>
												<td><span id="ec_shop_member_confirm_field-name_en"></span></td>
											</tr>
											<tr id="ec_shop_member_confirm-nation">
												<th>국적</th>
												<td><span id="ec_shop_member_confirm_field-citizenship"></span></td>
											</tr>
											<tr class="">
												<th scope="row">주소</th>
											...
											<tr class="">
												...
												<td><span id="ec_shop_member_confirm_field-phone"></span></td>
											</tr>
											<tr class="">
											...
											<tr class="displaynone">
												...
												<td><span id="ec_shop_member_confirm_field-is_sms"></span></td>
											</tr>
											<tr>
												<th scope="row">이메일</th>
											...
											<tr class="">
												...
												<td><span
													id="ec_shop_member_confirm_field-is_news_mail"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row">평생회원</th>
												<td><span id="ec_shop_member_confirm_field-is_lifetime"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row">별명</th>
												<td><span id="ec_shop_member_confirm_field-nick_name"></span></td>
											</tr>
											<tr class="">
												<th scope="row">성별</th>
											...
											<tr class="displaynone">
												...
												<td><span id="ec_shop_member_confirm_field-marry_year"></span><span>/</span><span
													id="ec_shop_member_confirm_field-marry_month"></span><span>/</span><span
													id="ec_shop_member_confirm_field-marry_day"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row">배우자생일</th>
												<td><span
													id="ec_shop_member_confirm_field-partner_year"></span><span>/</span><span
													id="ec_shop_member_confirm_field-partner_month"></span><span>/</span><span
													id="ec_shop_member_confirm_field-partner_day"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row">자녀</th>
												<td><span id="ec_shop_member_confirm_field-child"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row">최종학력</th>
												<td><span id="ec_shop_member_confirm_field-school"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row">직종</th>
												<td><span id="ec_shop_member_confirm_field-job_class"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row">직업</th>
												<td><span id="ec_shop_member_confirm_field-job"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row">연소득</th>
												<td><span id="ec_shop_member_confirm_field-earning"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row">자동차</th>
												<td><span id="ec_shop_member_confirm_field-car"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row">지역</th>
												<td><span id="ec_shop_member_confirm_field-region"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row">인터넷 이용장소</th>
												<td><span id="ec_shop_member_confirm_field-internet"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row">관심분야</th>
												<td><span id="ec_shop_member_confirm_field-inter_check"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row"></th>
												<td><span id="ec_shop_member_confirm_field-add1"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row"></th>
												<td><span id="ec_shop_member_confirm_field-add2"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row"></th>
												<td><span id="ec_shop_member_confirm_field-add3"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row"></th>
												<td><span id="ec_shop_member_confirm_field-add4"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row"></th>
												<td><span id="ec_shop_member_confirm_field-add5"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row"></th>
												<td><span id="ec_shop_member_confirm_field-add6"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row"></th>
												<td><span id="ec_shop_member_confirm_field-add7"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row"></th>
												<td><span id="ec_shop_member_confirm_field-add8"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row"></th>
												<td><span id="ec_shop_member_confirm_field-add9"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row"></th>
												<td><span id="ec_shop_member_confirm_field-add10"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row"></th>
												<td><span id="ec_shop_member_confirm_field-add11"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row"></th>
												<td><span id="ec_shop_member_confirm_field-add12"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row"></th>
												<td><span id="ec_shop_member_confirm_field-add13"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row"></th>
												<td><span id="ec_shop_member_confirm_field-add14"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row"></th>
												<td><span id="ec_shop_member_confirm_field-add15"></span></td>
											</tr>
											<tr class="displaynone">
												<th scope="row">추천인 아이디</th>
												<td><span id="ec_shop_member_confirm_field-reco_id"></span></td>
											</tr>
											<tr class="">
												...
												<td>
													<ul class="account">
														<li>예금주 : <span
															id="ec_shop_member_confirm_field-bank_account_owner"></span>
														</li>
														<li>은행명 : <span
															id="ec_shop_member_confirm_field-refund_bank_code"></span>
														</li>
														<li>계좌번호 : <span
															id="ec_shop_member_confirm_field-bank_account_no"></span>
														</li>
													</ul>
												</td>
											</tr>
